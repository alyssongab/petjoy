const Card = ({titulo, imgUrl, desc, botao}) => {
    return(
        <div id="card" className="bg-slate-50 flex flex-col rounded-2xl p-3 shadow-xl w-[85vw] h-[50vh] md:w-[60vw] md:h-[70vh] lg:w-[40vw] lg:h-[80vh] 2xl:w-[35vw] 2xl:h-[80vh] hover:scale-105 transition-all duration-300">
